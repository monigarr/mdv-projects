...
$('#home').live('pageinit', function()
{
	...
	//show console log message when returning back to home page
    // transition to page, using data from a form and reloading 
    // the page from scratch
    //use this way from now on, declare as var to hold function
    //so jqmobile won't go all wild hareyish
